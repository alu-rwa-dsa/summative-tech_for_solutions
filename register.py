...
def gui_f():
    ...
    first_name_field.bind("<Return>", focus.focus_first_name())
    middle_name_field.bind("<Return>", focus.focus_middle_name())
    last_name_field.bind("<Return>", focus.focus_last_name())
    gender_field.bind("<Return>", focus.focus_gender())
    Email_ID_field.bind("<Return>", focus.focus_email_ID())
    occupation_field.bind("<Return>", focus.focus_occupation())
    phone_n_field.bind("<Return>", focus.focus_phone_n())
    address_field.bind("<Return>", focus.focus_address())
